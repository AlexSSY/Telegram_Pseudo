...
@Composable
fun TelegramClientListItem(
    telegramClient: TelegramClient
) {
    val fullName = telegramClient.fullName.collectAsState()
    val profilePhotoPath = telegramClient.profilePhotoPathSafe.collectAsState()
    ...
    Row(
        ...
        Row(
            ...
            Column(
                ...
                Text(
                    text = telegramClient.phoneNumber.value ?: "----",
                    style = MaterialTheme.typography.labelSmall,
                    color = Color.Gray
                )
            }
